...
int tailleSommet=20;//devrait être dans le main
int tailleArret=20;//devrait être dans le main

Arbitre pArbitre;//tout ca dans le main
...
Arbitre initArbitre(int (*matrice)/*[tailleSommet]*/){
    ...
    Arbitre pArbitre;
    pArbitre=malloc(2*sizeof(int)+sizeof(int*)+sizeof(Sommet*));//sizeof Arbitre?
